...
public:
	...
	bool set_move_by_convoy_order( PROVINCE_INDEX unit, PROVINCE_INDEX destination, int number_of_steps, PROVINCE_INDEX step_list[] );
	...
	COAST_ID find_result_unit_initial_location( PROVINCE_INDEX province_index, 
			bool &is_new_build, bool &retreated_to_province, bool &moved_to_province, bool &unit_found );
