...
IDC_AICLIENT, szWindowClass, MAX_LOADSTRING);
...
hInstance = hInstance;
wcex.
hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_AICLIENT));
wcex.
hCursor = LoadCursor(NULL, IDC_ARROW);
wcex.
hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
wcex.
lpszMenuName = MAKEINTRESOURCE(IDC_AICLIENT);
wcex.
