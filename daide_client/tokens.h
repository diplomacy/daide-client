...
#ifndef _DIPAI_TOKENS_H
#define _DIPAI_TOKENS_H

#include "types.h"

typedef unsigned short LANGUAGE_TOKEN;
typedef BYTE LANGUAGE_CATEGORY;
...
public:
    ...
    inline Token(const LANGUAGE_CATEGORY category, const BYTE sub_category) {
